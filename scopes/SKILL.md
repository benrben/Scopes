---
name: scopes
description: Umbrella router for the Scopes toolkit. Use when the user’s intent is “do something with Scopes” but they didn’t pick a specific sub-skill. Routes to exactly one sub-skill (sync/query/plan/tasks/develop/tdd/refactor/scan/adr/brainstorm).
model: inherit
---
